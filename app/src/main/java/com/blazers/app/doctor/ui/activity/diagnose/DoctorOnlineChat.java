...
import com.blazers.app.doctor.adapter.DoctorOnlineChatMessageAdapter;
import com.blazers.app.doctor.model.bmob.AppUserModel;
import com.blazers.app.doctor.model.bmob.ChatModel;
...
import com.blazers.app.doctor.ui.common.ImageViewerActivity;
...
public class DoctorOnlineChat extends AppCompatActivity {
    ...
    private DoctorOnlineChatMessageAdapter adapter;
    ...
    void initViews() {
        ...
        /**/
        adapter = new DoctorOnlineChatMessageAdapter(this, testTargetId.getObjectId());
